  ...
  return (
    <>
      ...
      <main className="pt-16 md:pt-20 pb-16 md:pb-0 max-w-container-max mx-auto px-gutter mb-20">
        {/* Profile Header */}
        <div className="bg-white rounded-xl border border-border-low-contrast p-6 sm:p-8 mb-8">
        ...
        <div className="mb-8">
          ...
          <div className="space-y-4">
            {posts.map(post => (
              <div key={post.id} className="bg-white p-6 rounded-xl border border-border-low-contrast hover:shadow-md transition-all">

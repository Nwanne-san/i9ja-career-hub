  ...
  return (
    <div className="bg-primary-container rounded-xl sm:rounded-3xl p-4 sm:p-8 text-on-primary-container relative overflow-hidden shadow-lg mx-gutter">
      <div className="relative z-10">
        ...
        <button className="bg-bg-card text-primary px-4 sm:px-8 py-2 sm:py-3 rounded-full font-bold flex items-center gap-2 hover:bg-surface-container-lowest transition-all shadow-md active:scale-95 text-xs sm:text-sm">
          <span className="material-symbols-outlined text-sm">add_circle</span>
          Start New Thread
        </button>
      </div>
      {/* Decorative Elements */}
      <div className="absolute -right-16 -bottom-16 w-64 h-64 bg-bg-card/10 rounded-full blur-3xl"></div>
...
function ThreadCard({
  ...
  return (
    <article className="bg-bg-card border border-border-low-contrast rounded-lg sm:rounded-2xl p-3 sm:p-6 hover:shadow-md transition-all group">
      ...
      <main className="pt-16 md:pt-20 pb-16 md:pb-0 px-gutter max-w-container-max mx-auto min-h-screen space-y-6 sm:space-y-8 mb-8">
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-8">
          ...
          <div className="flex-1 space-y-4 sm:space-y-6">
            ...
            {/* Filters */}
            <div className="flex items-center justify-between bg-bg-card border border-border-low-contrast rounded-lg sm:rounded-2xl px-3 sm:px-6 py-2 sm:py-4 shadow-sm overflow-x-auto hide-scrollbar">
